...
export default function Header() {
  ...
  // zobraz menu všade okrem landing stránky "/"
    ...
    <header className="site-header">
      ...
      <style jsx>{`
        .site-header{
          ...
          padding:12px 16px;background:#eaf5e8;
        ...
        .hamb{display:none;position:relative;width:44px;height:36px;
          border:1px solid #cbdccb;border-radius:12px;background:#fff}
        .hamb span{position:absolute;left:10px;right:10px;height:2px;
          background:#2b4630;border-radius:2px;transition:transform .25s,opacity .2s,top .25s}
        ...
        @media (max-width: 860px){
          .nav{
            position:absolute;right:12px;top:60px;flex-direction:column;gap:10px;
            background:#fff;border:1px solid #dbe7dc;border-radius:14px;
            padding:12px;box-shadow:0 10px 30px #0001;display:none
          }
