...
// ak máš Layout, nechaj; ak nie, môžeš dočasne odstrániť Layout a použiť <main> priamo
...
export default function PlantPage() {
  ...
  // Posledná akcia pre animáciu (vitring/listy/efekty)
  ...
  useEffect(() => {
    ...
    if (st.xp >= need) {
      ...
      // tu si môžeš doplniť konfety / zvuk
    }
    const mood =
    ...
    <Layout>
      <main style={{ padding: 16, maxWidth: 960, margin: "0 auto" }}>
        <section className="card" style={{ marginBottom: 16 }}>
          ...
          {/* 3D rastlinka – ŽIADNE tlačidlá vo vnútri komponentu */}
